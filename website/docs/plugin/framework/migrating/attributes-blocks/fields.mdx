---
page_title: 'Attributes flags: Migrating from SDKv2 to the Framework'
description: >-
  Migrate attribute required, optional, computed and sensitive from SDKv2 to the plugin Framework
---

# Attribute Fields

A subset of attribute fields, such as required, optional, computed, or sensitive, define attribute behaviour. Refer to
