...
func WillHaveSizeBetween(minVal, maxVal int) planmodifier.List {
...
func (m willHaveSizeBetweenModifier) PlanModifyList(ctx context.Context, req planmodifier.ListRequest, resp *planmodifier.ListResponse) {
