...
Refer to the [Dynamic Data Handling](/terraform/plugin/framework/handling-data/terraform-concepts#dynamic-data-handling-caveats) documentation for more information.
