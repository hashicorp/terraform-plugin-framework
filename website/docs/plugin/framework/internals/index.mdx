...
Refer to [RPCs](/plugin/framework/internals/rpcs) for details of the [sequence of RPCs](/plugin/terraform-plugin-protocol#rpcs-and-terraform-commands) that are issued when Terraform commands are executed and Framework functionality that is called as a consequence.
