...
Default values support is only available in the Framework for resources. Default values for data sources and
providers should be handled within the [data source configure method](/terraform/plugin/framework/data-sources/configure#define-data-source-configure-method)
or the [provider configure method](/terraform/plugin/framework/providers#configure-method), respectively.
