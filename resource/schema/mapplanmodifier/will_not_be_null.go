...
//		// Will successfully evalutate during plan with a "not null" refinement on "map_attribute"
//		count = examplecloud_thing.a.map_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.Map {
...
func (m willNotBeNullModifier) PlanModifyMap(ctx context.Context, req planmodifier.MapRequest, resp *planmodifier.MapResponse) {
