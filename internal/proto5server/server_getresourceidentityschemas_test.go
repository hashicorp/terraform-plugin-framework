...
func TestServerGetResourceIdentitySchemas(t *testing.T) {
	...
	testCases := map[string]struct {
		server           *Server
		request          *tfprotov5.GetResourceIdentitySchemasRequest
		expectedError    error
		expectedResponse *tfprotov5.GetResourceIdentitySchemasResponse
	}{
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			got, err := testCase.server.GetResourceIdentitySchemas(context.Background(), new(tfprotov5.GetResourceIdentitySchemasRequest))
...
func TestServerGetResourceIdentitySchemas_logging(t *testing.T) {
	...
	_, err := testServer.GetResourceIdentitySchemas(ctx, new(tfprotov5.GetResourceIdentitySchemasRequest))
