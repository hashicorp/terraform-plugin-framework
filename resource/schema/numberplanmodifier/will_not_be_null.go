...
//		// Will successfully evalutate during plan with a "not null" refinement on "number_attribute"
//		count = examplecloud_thing.a.number_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.Number {
...
func (m willNotBeNullModifier) PlanModifyNumber(ctx context.Context, req planmodifier.NumberRequest, resp *planmodifier.NumberResponse) {
