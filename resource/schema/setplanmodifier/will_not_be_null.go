...
//		// Will successfully evalutate during plan with a "not null" refinement on "set_attribute"
//		count = examplecloud_thing.a.set_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.Set {
...
func (m willNotBeNullModifier) PlanModifySet(ctx context.Context, req planmodifier.SetRequest, resp *planmodifier.SetResponse) {
