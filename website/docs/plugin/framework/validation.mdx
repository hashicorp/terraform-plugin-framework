...
During execution of the [`terraform validate`](/cli/commands/validate), [`terraform plan`](/cli/commands/plan), [`terraform apply`](/cli/commands/apply) and [`terraform destroy`](/cli/commands/destroy) commands, Terraform calls the provider [`ValidateProviderConfig`](/plugin/framework/internals/rpcs#validateproviderconfig-rpc), [`ValidateResourceConfig`](/plugin/framework/internals/rpcs#validateresourceconfig-rpc) and [`ValidateDataResourceConfig`](/plugin/framework/internals/rpcs#validatedataresourceconfig-rpc) RPCs.
