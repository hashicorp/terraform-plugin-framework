...
func WillHaveSizeAtLeast(minVal int) planmodifier.Set {
...
func (m willHaveSizeAtLeastModifier) PlanModifySet(ctx context.Context, req planmodifier.SetRequest, resp *planmodifier.SetResponse) {
