...
func TestNumber_bigFloat(t *testing.T) {
	...
	result, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, 123456), reflect.ValueOf(f), refl.Options{}, attrpath.New())
	if diags.HasError() {
...
func TestNumber_bigInt(t *testing.T) {
	...
	result, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, 123456), reflect.ValueOf(n), refl.Options{}, attrpath.New())
	if diags.HasError() {
		t.Errorf("Unexpected error: %v", diags)
	}
...
func TestNumber_bigIntRoundingError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, 123456.123), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int(t *testing.T) {
	...
	result, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, 123), reflect.ValueOf(n), refl.Options{}, attrpath.New())
	if diags.HasError() {
		t.Errorf("Unexpected error: %v", diags)
	}
	reflect.ValueOf(&n).Elem().Set(result)
...
func TestNumber_intOverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, overflowInt), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_intUnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, underflowInt), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int8OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxInt8+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int8UnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MinInt8-1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int16OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxInt16+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int16UnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MinInt16-1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int32OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxInt32+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_int32UnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MinInt32-1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_uintOverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, overflowUint), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_uintUnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, -1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_uint8OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxUint8+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_uint16OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxUint16+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_uint32OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxUint32+1), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float32OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.MaxFloat64), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float32UnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, math.SmallestNonzeroFloat64), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float64OverflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, overflowFloat), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float64OverflowNegativeError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, overflowNegativeFloat), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float64UnderflowError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, underflowFloat), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestNumber_float64UnderflowNegativeError(t *testing.T) {
	...
	_, diags := refl.Number(context.Background(), types.NumberType, tftypes.NewValue(tftypes.Number, underflowNegativeFloat), reflect.ValueOf(n), refl.Options{}, attrpath.New())
...
func TestFromInt(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			t.Parallel()
			actualVal, diags := refl.FromInt(context.Background(), tc.typ, tc.val, attrpath.New())
...
func TestFromUint(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			t.Parallel()
			actualVal, diags := refl.FromUint(context.Background(), tc.typ, tc.val, attrpath.New())
...
func TestFromFloat(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			t.Parallel()
			actualVal, diags := refl.FromFloat(context.Background(), tc.typ, tc.val, attrpath.New())
...
func TestFromBigFloat(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			t.Parallel()
			actualVal, diags := refl.FromBigFloat(context.Background(), tc.typ, tc.val, attrpath.New())
...
func TestFromBigInt(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			t.Parallel()
			actualVal, diags := refl.FromBigInt(context.Background(), tc.typ, tc.val, attrpath.New())
