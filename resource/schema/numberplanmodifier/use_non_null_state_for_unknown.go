...
func UseNonNullStateForUnknown() planmodifier.Number {
...
func (m useNonNullStateForUnknown) PlanModifyNumber(ctx context.Context, req planmodifier.NumberRequest, resp *planmodifier.NumberResponse) {
