...
//		// Will successfully evalutate during plan with a "not null" refinement on "float32_attribute"
//		count = examplecloud_thing.a.float32_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.Float32 {
