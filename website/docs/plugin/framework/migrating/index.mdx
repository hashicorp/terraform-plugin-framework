...
- Update each of the provider's resources and data sources.
  ...
  - Update the resource or data source's [CRUD function](/plugin/framework/migrating/resources/crud) definitions.
  - Update the resource or data source's [attribute schema](/plugin/framework/migrating/attributes/schema).
  - Update the resource's [import function](/plugin/framework/migrating/resources/import), if your provider supports importing the resource.
