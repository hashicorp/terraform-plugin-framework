...
func TestPrimitive_string(t *testing.T) {
	...
	result, diags := refl.Primitive(context.Background(), types.StringType, tftypes.NewValue(tftypes.String, "hello"), reflect.ValueOf(s), path.EmptyPath())
	if diags.HasError() {
...
func TestPrimitive_bool(t *testing.T) {
	...
	result, diags := refl.Primitive(context.Background(), types.BoolType, tftypes.NewValue(tftypes.Bool, true), reflect.ValueOf(b), path.EmptyPath())
	if diags.HasError() {
		t.Errorf("Unexpected error: %v", diags)
	}
...
func TestFromString(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, diags := refl.FromString(context.Background(), tc.typ, tc.val, path.EmptyPath())
...
func TestFromBool(t *testing.T) {
	...
	for name, tc := range cases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, diags := refl.FromBool(context.Background(), tc.typ, tc.val, path.EmptyPath())
