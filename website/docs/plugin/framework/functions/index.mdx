...
-> **Note:** It is possible to add functions to an existing provider. If you do not have an existing provider, you will need to create your own provider to contain the functions. Please see the [Terraform Plugin Framework documentation](/terraform/plugin/framework/getting-started/code-walkthrough) to learn how to create your first provider.
