...
object. Refer to the [conversion rules](/plugin/framework/handling-data/conversion-rules#converting-from-go-types-to-framework-types) for an explanation on how
