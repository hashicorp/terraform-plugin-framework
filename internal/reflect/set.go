...
func Set(ctx context.Context, val attr.Value, target reflect.Value, opts Options, path *tftypes.AttributePath) (reflect.Value, diag.Diagnostics) {
	...
	for _, value := range values {
		...
		valPath := path.WithElementKeyValue(tfValue)
