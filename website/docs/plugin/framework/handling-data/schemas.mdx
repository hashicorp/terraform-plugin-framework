...
[Nested attributes](/plugin/framework/getting-started/core-configuration-concepts#nested-attributes) enable provider developers to define objects of attributes which fully support attribute behaviors and practitioners to configure these directly using [expressions](/language/expressions).
