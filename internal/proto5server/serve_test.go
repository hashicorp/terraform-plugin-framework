...
func testNewSingleValueDynamicValue(t *testing.T, argumentValue tftypes.Value) *tfprotov5.DynamicValue {
	t.Helper()

	dynamicValue, err := tfprotov5.NewDynamicValue(argumentValue.Type(), argumentValue)
