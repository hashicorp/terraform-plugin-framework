...
This page explains the differences between the schema used by SDKv2 and the Framework. For further schema-specific documentation, refer to the other migration guides in this section:
