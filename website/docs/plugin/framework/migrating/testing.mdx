...
relates to the provider factories that create the provider during the test case.
...
Refer to [Acceptance Tests - Specify Providers](/plugin/framework/acctests#specify-providers) in the Framework
