...
//		// Will successfully evalutate during plan with a "not null" refinement on "list_attribute"
//		count = examplecloud_thing.a.list_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.List {
...
func (m willNotBeNullModifier) PlanModifyList(ctx context.Context, req planmodifier.ListRequest, resp *planmodifier.ListResponse) {
