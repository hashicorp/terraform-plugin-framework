...
//		// Will successfully evalutate during plan with a "not null" refinement on "object_attribute"
//		count = examplecloud_thing.a.object_attribute != null ? 1 : 0
//
//		// .. resource config
//	}
func WillNotBeNull() planmodifier.Object {
...
func (m willNotBeNullModifier) PlanModifyObject(ctx context.Context, req planmodifier.ObjectRequest, resp *planmodifier.ObjectResponse) {
