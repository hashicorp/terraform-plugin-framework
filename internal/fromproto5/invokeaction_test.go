...
func TestInvokeActionRequest(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			got, diags := fromproto5.InvokeActionRequest(context.Background(), testCase.input, testCase.actionImpl, testCase.actionSchema, testCase.linkedResourceSchemas, testCase.linkedResourceIdentitySchemas)
