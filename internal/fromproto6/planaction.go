...
func PlanActionRequest(ctx context.Context, proto6 *tfprotov6.PlanActionRequest, reqAction action.Action, actionSchema fwschema.Schema, linkedResourceSchemas []fwschema.Schema, linkedResourceIdentitySchemas []fwschema.Schema) (*fwserver.PlanActionRequest, diag.Diagnostics) {
	if proto6 == nil {
		return nil, nil
	}
	...
	for i, linkedResource := range proto6.LinkedResources {
		...
		fw.LinkedResources = append(fw.LinkedResources, &fwserver.PlanActionRequestLinkedResource{
			Config:        config,
