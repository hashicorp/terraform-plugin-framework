...
//
// See the AttributeErrorDiagnostic, AttributeWarningDiagnostic,
// ErrorDiagnostic, and WarningDiagnostic concrete types for generic
// implementations.
type Diagnostic interface {
	...
	// SetPath sets the attribute path for the diagnostic.
	SetPath(*tftypes.AttributePath)
