...
[providers](https://github.com/hashicorp/terraform-plugin-framework-validators/tree/main/providervalidator),
[resources](https://github.com/hashicorp/terraform-plugin-framework-validators/tree/main/resourcevalidator) and
[data sources](https://github.com/hashicorp/terraform-plugin-framework-validators/tree/main/datasourcevalidator) by
...
available for the Framework:
  - [ConflictsWith](https://github.com/hashicorp/terraform-plugin-framework-validators/blob/v0.4.0/schemavalidator/conflicts_with.go)
  - [ExactlyOneOf](https://github.com/hashicorp/terraform-plugin-framework-validators/blob/v0.4.0/schemavalidator/exactly_one_of.go)
  - [AtLeastOneOf](https://github.com/hashicorp/terraform-plugin-framework-validators/blob/v0.4.0/schemavalidator/at_least_one_of.go)
  - [AlsoRequires](https://github.com/hashicorp/terraform-plugin-framework-validators/blob/v0.4.0/schemavalidator/also_requires.go)
