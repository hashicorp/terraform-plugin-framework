...
This page explains how to migrate a primitive attribute from SDKv2 to the plugin Framework. There is an example of
migrating a nested block to a nested attribute in
[Provider Schema](/plugin/framework/migrating/provider#example-1)
...
nested attribute. Nested attributes are also described in more detail in the
[docs](https://www.terraform.io/plugin/framework/schemas#attributes-1).
