...
func TestNewStruct_notAnObject(t *testing.T) {
	...
	_, diags := refl.Struct(context.Background(), types.StringType, tftypes.NewValue(tftypes.String, "hello"), reflect.ValueOf(s), refl.Options{}, attrpath.New())
...
func TestNewStruct_notAStruct(t *testing.T) {
	...
	}, val, reflect.ValueOf(s), refl.Options{}, attrpath.New())
...
func TestNewStruct_objectMissingFields(t *testing.T) {
	...
	_, diags := refl.Struct(context.Background(), types.ObjectType{}, val, reflect.ValueOf(s), refl.Options{}, attrpath.New())
...
func TestNewStruct_primitives(t *testing.T) {
	...
	}), reflect.ValueOf(s), refl.Options{}, attrpath.New())
	if diags.HasError() {
...
func TestFromStruct_primitives(t *testing.T) {
	...
	}, reflect.ValueOf(disk1), attrpath.New())
	if diags.HasError() {
...
func TestFromStruct_complex(t *testing.T) {
	...
	}, reflect.ValueOf(s), attrpath.New())
	if diags.HasError() {
		t.Errorf("Unexpected error: %v", diags)
	}
