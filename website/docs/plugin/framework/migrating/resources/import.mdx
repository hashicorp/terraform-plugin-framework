...
In the simple use case in which `schema.ImportStatePassthroughContext` has been used with SDKv2, migrating simply
involves using `resource.ImportStatePassthroughID`.
