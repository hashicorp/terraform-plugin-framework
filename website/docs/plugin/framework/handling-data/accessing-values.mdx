...
accessed like an object. Refer to the [conversion rules](/plugin/framework/handling-data/conversion-rules#converting-from-framework-types-to-go-types) for an
