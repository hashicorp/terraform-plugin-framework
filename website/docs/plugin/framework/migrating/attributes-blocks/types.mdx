...
migrating a nested block to a nested attribute, refer to [Provider Schema](/plugin/framework/migrating/providers#example-1) in the Framework documentation.
...
[Provider Schema](/plugin/framework/migrating/providers#example-1) for an example of using a single
