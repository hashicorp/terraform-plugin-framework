...
func TestValidateStateStoreRequest(t *testing.T) {
	t.Parallel()
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			got, diags := fromproto6.ValidateStateStoreRequest(context.Background(), testCase.input, testCase.statestoreResource, testCase.statestoreResourceSchema)
